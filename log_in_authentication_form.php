	...
	if ($user_authenticated  == 0){
	                ?>                      
                        <div class="container">
                                <div class="row">
                                        <div class="twelve columns" style="margin-top: 1%; text-align: center">
                                                ...
                                                echo "<input type=\"submit\" class=\"top_buttons\" style=\"padding: 0px 10px;\" name=\"action\" value=\"login\">";
                                                echo "</form>"; 
                                                ?>
                                                <BR>
                                        </div>
                        ...
                        <div class="container_with_border">
                                <div class="row">
                                        <div class="twelve columns" style="margin-top: 0%; text-align: center">
                                                <BR><BR>
                                                <!-- <div align="center">All data entered into this demo database will be erased in every 24 hours and the databse will be reset.<BR><BR>Case sensitive password. <BR><BR> Username : Barry   Password : bluesky<BR><BR><BR><BR></div> -->
                                        </div>
                                </div>
                        </div>
                        <?PHP 
		                        ...
		                        $User_db_token = $rowlog['User_db_token'];
	                                ...
	                                // Compare the DB token with the POST one passed from the previous page.
                                        if ($User_db_token == $login_instance_token) {
                                                ...
                                                <div class="container" style="border: 0px solid #bbb;">
                                                        <div class="row">
                                                               ...
                                                               // echo "          <TD>":
                                                                ...
                                                                echo "<TABLE>";
                                                                echo "  <TR>";
                                                                                user_button($UserID);  // Foun in search_functions.php
                                                                ...
                                                                //echo "          <TD>":
                                                                                ...
                                                                                echo "  <input type=\"submit\" class=\"top_buttons\" name=\"action\" style=\"padding: 0px 10px;\" value=\" Log Off\">";
                                                                                // echo "here what<BR>";
                                                                                echo "  </form>";
                                                                                // echo "</div> ";
                                                                //echo "          </TD>":
                                                                echo "  </TR>";
                                                                echo "</TABLE>";
                                                                echo "<img src=\"images/spacer.gif\" width=\"5\" height=\"6\" alt=\"\" FACE=\"Arial\" SIZE=\"\"; COLOR=\"white\">";
