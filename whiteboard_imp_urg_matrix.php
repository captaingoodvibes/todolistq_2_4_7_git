...
echo "<TABLE border=\"0\" >
					<TR>
						<TD align=\"middle\" bgcolor =\"$color_imp_urg_A\" width=\"15\" height=\"15\" ><div title=\"Important and Urgent\">";
		        ...
		        echo "                          </div>";
						        echo "<form method=\"post\" action=\"./whiteBoard.php\">";
		                                        ...
		                                        echo "<input type=\"hidden\" name=\"jobNumber\" value=\"" . $jobNumber . "\">";
                                                        ...
                                                        echo "</form>";
			echo "                  </TD>
						<TD align=\"middle\" bgcolor =\"$color_imp_urg_B\" width=\"15\" height=\"15\"><div title=\"Important and Urgent\">";
			...
			echo "	                </TD>
					...
					<TR>
						<TD align=\"middle\" bgcolor =\"$color_imp_urg_C\" width=\"15\" height=\"15\"><div title=\"NOT Important but Urgent\">";
						        echo "<form method=\"post\" action=\"./whiteBoard.php\">";
		                                        echo "<input type=\"hidden\" name=\"JobID\" value=\"" . $JobID . "\">";
			...
			echo "                          </div>";
			echo "	                </TD>
						<TD align=\"middle\" bgcolor =\"$color_imp_urg_D\" width=\"15\" height=\"15\"><div title=\"NOT Important and NOT Urgent\">";
						        echo "<form method=\"post\" action=\"./whiteBoard.php\">";
		                                        echo "<input type=\"hidden\" name=\"JobID\" value=\"" . $JobID . "\">";
